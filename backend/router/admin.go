...
func registerAdminRoutes(r *gin.Engine) {
	...
	admin := r.Group("/admin")
	{
		...
		protected.Use(middleware.AdminAuth())
		{
			...
			protected.POST("/founder/reports/:id/decisions/:index/approve", founderHandler.DecisionApprove)
			protected.POST("/founder/reports/:id/decisions/:index/hold", founderHandler.DecisionHold)
			protected.POST("/founder/reports/:id/decisions/:index/reject", founderHandler.DecisionReject)
