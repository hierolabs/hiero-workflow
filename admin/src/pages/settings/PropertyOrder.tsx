...
export default function PropertyOrder() {
  ...
  const fetchProperties = useCallback(async () => {
    setLoading(true);
    const res = await fetch(`${API_URL}/properties?page=1&page_size=500`, {
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="mt-2 text-2xl font-bold text-gray-900">숙소 표시 순서</h1>
        <p className="mt-1 text-sm text-gray-500">
          드래그 또는 버튼으로 숙소 표시 순서를 조정합니다 (캘린더/공간관리 공통)
        </p>
      </div>
